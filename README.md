...
This repository is for learning how to classify images with machine learning algorithms with tensorflow + keras using some of the sample image datasets embedded within tensorflow. I plan to add more folders with classification tasks throughout the year.
